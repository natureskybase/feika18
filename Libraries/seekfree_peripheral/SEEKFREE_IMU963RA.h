...
//=====================================================软件 IIC 驱动====================================================
	#define IMU963RA_SCL_PIN            (P44)     	// 软件 IIC SCL 引脚 连接 IMU660RA 的 SCL 引脚
	#define IMU963RA_SDA_PIN            (P43)      	// 软件 IIC SDA 引脚 连接 IMU660RA 的 SDA 引脚
	#define IMU963RA_SOFT_IIC_DELAY     (0  )   	// 软件 IIC 的时钟延时周期 数值越小 IIC 通信速率越快
//=====================================================软件 IIC 驱动====================================================
#else
//=====================================================软件 SPI 驱动====================================================
	#define IMU963RA_SPC_PIN            (P44)      	// 软件 SPI SCK 引脚
	#define IMU963RA_SDI_PIN            (P43)      	// 软件 SPI MOSI 引脚
	#define IMU963RA_SDO_PIN            (P42)      	// 软件 SPI MISO 引脚
	#define IMU963RA_CS_PIN             (P41)      	// 软件 SPI CS 引脚
//=====================================================软件 SPI 驱动====================================================
#endif
